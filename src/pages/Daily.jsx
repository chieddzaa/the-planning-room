...
const Daily = forwardRef(function Daily({ username, onSavingChange }, ref) {
  // Schedule (time blocks)
  const [schedule, setSchedule] = useLocalStorageState(
  ...
  // Top 3 Today
  const [top3Today, setTop3Today] = useLocalStorageState(
  ...
  // Mood/Energy
  const [moodEnergy, setMoodEnergy] = useLocalStorageState(
